...
// Inject takes the Trace instance and injects it for propagation within
// `carrier`. The actual type of `carrier` depends on the value of `format`.
